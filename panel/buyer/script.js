...
function displayProducts() {
  ...
  products.forEach((p) => {
    ...
    card.innerHTML = `
      <button class="wishlist-btn style="background-color: transparent; padding-left: 6px;" ${liked ? "active" : ""}" data-id="${p.id}"><img src="images/wishlist.png" alt="Wishlist" class="btn-icon"></button>
...
function displayWishlist() {
  ...
  wishlist.forEach((product) => {
    ...
    card.innerHTML = `
      <button class="wishlist-btn active" style="background-color: transparent; padding-left: 6px;" data-product-id="${product.id}"><img src="images/wishlist.png" alt="Wishlist" class="btn-icon"></button>
      <div class="product-image">
